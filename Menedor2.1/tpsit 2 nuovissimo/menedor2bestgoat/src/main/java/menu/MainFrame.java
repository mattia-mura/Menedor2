...
public class MainFrame extends JFrame {
    ...
    private void gestisciTransazione(int tipo) {
        ...
        try {
            ...
            boolean successo = Main.depositPreleva(tipo, importo, portafoglioSolidi, contoVirtuale);
    ...
    public void avanzaMese() {
        ...
        for (int i=0;i<nInvestimenti;i++){
            ...
            if (tempInvestimento[i]==0) {
                ...
                if (Investimenti[i] <= 0) {
                    contoVirtuale.decrementaSaldo(Investimenti[i]);
                } else {
                    contoVirtuale.aumentaSaldo(Investimenti[i]);
                    Investimenti[i] = -777777;
                    Main.scalaInvestimenti(Investimenti,nMaxInvestimenti);
                }
